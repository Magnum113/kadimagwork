...
const campaignMetrics = [
  ...
  ['Продажи iPhone 18 net', '3 850', 'Superset'],
  ...
  return (
    <>
      <section id="strategy" aria-labelledby="strategy-title">
        ...
        <div className="strategy-layout">
          ...
          <div className="objective-stack">
            <div className="objective-row"><span className="objective-icon"><ShoppingBag /></span><div><strong>Бизнес</strong><p>3 850 продаж iPhone 18 net.</p></div></div>
      ...
      <section id="history" aria-labelledby="history-title">
        <div className="section-heading">
          <div><p className="section-kicker">Основание цели</p><h2 id="history-title">Продажи прошлых запусков</h2></div>
          <p className="section-summary">План iPhone 18 — 3 850 устройств net, на 16,6% выше результата iPhone 17.</p>
        </div>
        <Card className="chart-card">
          <CardHeader><CardTitle>Продажи смартфонов net</CardTitle><CardDescription>Период сравнения: 20 сентября — 1 ноября</CardDescription></CardHeader>
          <CardContent>
            ...
            <div className="chart-legend"><span><i className="legend-history" /> Факт</span><span><i className="legend-target" /> План 2026</span></div>
          </CardContent>
        </Card>
      </section>
